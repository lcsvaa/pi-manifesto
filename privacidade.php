...
<body>
    ...
    <div class="privacy-container">
        <div class="privacy-section">
            <h2>Introdução</h2>
            <p>A Nome da Loja ("nós", "nosso", "nossa") valoriza a privacidade de seus clientes e usuários. Esta
                Política de Privacidade explica como coletamos, usamos, compartilhamos e protegemos suas informações
                pessoais quando você visita nosso site ou faz compras conosco.</p>

            <div class="highlight">
                <p>Ao utilizar nosso site, você concorda com a coleta e uso de informações de acordo com esta política.
                    Se não concordar com estes termos, por favor, não acesse ou use nosso site.</p>
            </div>
        </div>
        ...
        <div class="privacy-section">
            ...
            <div class="highlight">
                <p>Todos os parceiros que recebem seus dados são obrigados a manter a mesma proteção e sigilo que nós
                    oferecemos.</p>
            </div>
        </div>
        ...
        <div class="privacy-section">
            ...
            <p>Você pode controlar o uso de cookies nas configurações do seu navegador, mas isso pode afetar algumas
        ...
        <div class="privacy-section">
            ...
            <p>Nenhum método de transmissão ou armazenamento eletrônico é 100% seguro, mas nos comprometemos a manter os
                mais altos padrões de proteção.</p>
        </div>

        <div class="privacy-section">
            <h2>Alterações nesta Política</h2>
            <p>Podemos atualizar esta Política de Privacidade periodicamente. A versão mais recente estará sempre
                disponível em nosso site com a data de atualização.</p>
        ...
        <div class="privacy-section">
            <h2>Contato</h2>
            <p>Se tiver dúvidas sobre esta Política de Privacidade ou sobre como tratamos seus dados pessoais, entre em
                contato conosco:</p>
