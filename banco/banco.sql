CREATE DATABASE senactito_db_manifestodb_manifesto
...
CREATE TABLE tb_itemCompra (
    ...
    CONSTRAINT fk_item_produto_tamanho FOREIGN KEY (idProduto, tamanho) 
        REFERENCES tb_produto_tamanho (idProduto, tamanho)
) DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
